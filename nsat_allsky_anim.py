...
if __name__ == "__main__":
    ...
    parser.add_argument("-c", "--config", help="Instrument configuration [file, default: instruments/rubin_lsst.yaml]",
                        metavar="FILE", default="instruments/rubin_lsst.yaml")
    parser.add_argument("-C", "--constellation", help="Satellite constellation configuration [file, default: constellations/starlink_gen2.yaml]",
                        metavar="FILE", default="constellations/starlink_gen2.yaml")
